...
def main():
    ...
    try:
        ...
        # MOQT uses UDP; update URL scheme to reflect QUIC transport
        moqt_port = 20002
        ...
        # Generate dev TLS certs for QUIC (self-signed, local dev only)
        ...
        # Replace A2AStarletteApplication + uvicorn with MOQTAgentServer
